...
class DecoderLayer(nn.Module):
    ...
    def __init__(self, d_model, ffn_hidden, num_heads, drop_out):
        ...
        self.ffn = PositionWiseFeedForward(d_model=d_model, hidden=ffn_hidden, drop_out=drop_out)
...
class Decoder(nn.Module):
    def __init__(self, d_model, ffn_hidden, num_heads, drop_out, num_layers=1):
        super().__init__()
        self.layers = SequentialDecoder(*[DecoderLayer(d_model, ffn_hidden, num_heads, drop_out) 
...
if __name__ == "__main__":
    ...
    decoder = Decoder(d_model, ffn_hidden, num_heads, drop_out, num_layers)
